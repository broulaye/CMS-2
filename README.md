...
* [x]  Bonus Objective 1: Identify security flaw in Objective #4 (requiring login on staff pages)
  ...
  * it does not follow the least priviledge security principal, allowing every logged in user to modify the database.
  this can be modified by allowing only users with certain clearance to delete, add or update the database.
...
<img src='http://i.imgur.com/wYxn8sa.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
